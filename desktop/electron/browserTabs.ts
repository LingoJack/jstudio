...
/** Height of the title-bar strip for the inline panel — matches the `h-9`
 *  row in AppTitleBar. main.ts uses it for cursor-hover polling (drag
 *  regions swallow DOM mouse events, so the bar can't detect the cursor
 *  itself). */
