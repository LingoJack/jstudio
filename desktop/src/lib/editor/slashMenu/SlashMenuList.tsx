...
> = {
  ...
  "Bullet List": {
    title: "slash.bulletList",
    description: "slash.bulletListDesc",
  },
  "Numbered List": {
    title: "slash.numberedList",
    description: "slash.numberedListDesc",
  },
  "To-do List": { title: "slash.todoList", description: "slash.todoListDesc" },
  Quote: { title: "slash.quote", description: "slash.quoteDesc" },
  "Code Block": {
    title: "slash.codeBlock",
    description: "slash.codeBlockDesc",
  },
  ...
  "Inline Link": {
    title: "slash.inlineLink",
    description: "slash.inlineLinkDesc",
  },
