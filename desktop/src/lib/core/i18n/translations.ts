export const translations = {
  zh: {
    ...
    "doclist.syncDirectory": "同步目录",
    "doclist.syncDirEmpty": "没有新增文档，同名文档已全部存在",
    "doclist.syncDirSuccess": "已同步 {count} 篇新文档",
    "doclist.syncDirFailed": "同步目录失败",
    "doclist.rename": "重命名",
    "doclist.delete": "删除",
    ...
    "backup.abnormalShrink":
      "检测到「{title}」内容大幅减少（{oldCount} → {newCount} 块，{oldCharCount} → {newCharCount} 字符），已自动备份。如非预期，可点击恢复。",
    "backup.restoreAction": "恢复备份",
    "backup.charCount": "{count} 字符",
    "backup.nodeCount": "{count} 节点",
    "backup.liveSnapshot": "实时编辑器快照",
    "backup.liveSnapshotDesc": "绕过序列化的原始编辑器状态，用于崩溃恢复",
    "backup.liveSnapshotRestore": "从快照恢复",
    "backup.preview": "预览",
    "backup.close": "关闭",
    "backup.loading": "加载中...",
    ...
    // ── Account section ──
    "account.desc":
      "登录自部署的后端服务，启用远程保存。会话令牌保存在本地，密码不会被存储。",
    "account.serverUrl": "服务器地址",
    "account.serverUrlPlaceholder": "http://127.0.0.1:8080",
    "account.username": "用户名",
    "account.usernamePlaceholder": "3-32 个字符",
    "account.password": "密码",
    "account.passwordPlaceholder": "至少 8 个字符",
    "account.showPassword": "显示密码",
    "account.hidePassword": "隐藏密码",
    "account.login": "登录",
    "account.register": "注册并登录",
    "account.logout": "退出登录",
    "account.userId": "用户 ID",
    "account.tokenExpiresAt": "令牌到期",
    "account.status": "账户状态",
    "account.status.connected": "已连接",
    "account.status.offline": "离线",
    "account.offlineHint":
      "无法连接服务器。登录令牌已保留，下次启动会自动重试。",
    "account.recheck": "重新验证",
    "account.expiredNotice": "登录已过期或已失效，请重新登录。",
    "account.error.network": "无法连接服务器，请检查地址与网络。",
    "account.error.invalidCredentials": "用户名或密码错误。",
    "account.error.usernameTaken": "用户名已被占用。",
    "account.error.invalidRequest":
      "输入不符合要求：用户名 3-32 个字符，密码至少 8 个字符。",
    "account.error.unknown": "请求失败，请稍后重试。",
    "account.loginSuccess": "已登录远程账户",
    "account.registerSuccess": "已注册并登录",
    "account.logoutSuccess": "已退出远程账户",
    ...
    "slash.inlineFormula": "行内公式",
    "slash.inlineFormulaDesc": "插入行内 LaTeX 公式",
  ...
  en: {
    ...
    "doclist.syncDirectory": "Sync Directory",
    "doclist.syncDirEmpty":
      "Nothing new to sync — every file name already exists",
    "doclist.syncDirSuccess": "Synced {count} new documents",
    "doclist.syncDirFailed": "Failed to sync directory",
    ...
    "backup.abnormalShrink":
      'Large content drop detected in "{title}" ({oldCount} -> {newCount} blocks, {oldCharCount} -> {newCharCount} chars). A backup was saved. Click to restore if unexpected.',
    ...
    "settings.account": "Remote Account",
    ...
    // ── Account section ──
    "account.desc":
      "Log in to your self-hosted backend to enable remote save. The session token is stored locally; your password never is.",
    "account.serverUrl": "Server URL",
    "account.serverUrlPlaceholder": "http://127.0.0.1:8080",
    "account.username": "Username",
    "account.usernamePlaceholder": "3-32 characters",
    ...
    "account.register": "Register & Log In",
    "account.logout": "Log Out",
    "account.userId": "User ID",
    "account.tokenExpiresAt": "Token Expires",
    ...
    "account.error.invalidRequest":
      "Invalid input: username must be 3-32 characters, password at least 8.",
    "account.error.unknown": "Request failed. Please try again later.",
    "account.loginSuccess": "Logged in to remote account",
    "account.registerSuccess": "Registered and logged in",
    "account.logoutSuccess": "Logged out of remote account",
    ...
    "slash.inlineFormula": "Inline formula",
    "slash.inlineFormulaDesc": "Insert an inline LaTeX formula",
