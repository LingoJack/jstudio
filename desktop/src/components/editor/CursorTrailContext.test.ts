...
function createFakeTrail() {
  ...
  } as unknown as EditorCursorTrail;

  return {
    trail,
    nativeRegistered,
    contentRegistered,
    get nativeDisposed() { return nativeDisposed; },
    get contentDisposed() { return contentDisposed; },
    get dirtyCount() { return dirtyCount; },
  };
}

const nativeHost = () => ({}) as NativeCaretHost;
const contentHost = () => ({}) as HTMLElement;
