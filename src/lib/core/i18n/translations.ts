export const translations = {
  zh: {
    ...
    "agent.share": "分享",
    "agent.favorite": "收藏",
    "agent.unfavorite": "取消收藏",
    "agent.selectOrCreateTask": "选择或创建一个任务开始",
    "agent.nextSteps": "下一步你可以计划做的事",
    "agent.reference": "引用对话文件",
    "agent.disclaimer": "内容由 AI 生成，请谨慎重要信息",
    "agent.modelVersion": "4.3",
  ...
  en: {
    ...
    "agent.workspaceHint":
      "Agent will operate within this directory (required)",
    ...
    "agent.unfavorite": "Unfavorite",
    "agent.selectOrCreateTask": "Select or create a task to start",
    "agent.nextSteps": "What you can plan next",
