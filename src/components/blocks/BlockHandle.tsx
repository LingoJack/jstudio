...
export default function BlockHandle({
  ...
  return (
    <>
      ...
      <div
        className="absolute right-full top-0 flex items-center gap-0.5 pr-1 opacity-0 group-hover/block:opacity-100 transition-opacity duration-100 select-none block-handle-active"
