 ...
 * M 暗夜霓虹：双色变体。
 *
 * - dark（原 SVG 设计）：深底 #0D1117 + 高亮霓虹描边/文字，赛博朋克感。
 * - light（浅色主题适配）：白底 #FFFFFF + 加深的霓虹色（保留色相但降低明度），
 *   避免深色节点贴在白画布上产生强烈割裂感；同时保证文字对比度可读。
 */
const NEON_ROOT = {
...
/**
 * M 霓虹：所有节点 fill。
 * - dark：同画布深底色，让节点"漂浮"仅靠霓虹描边勾勒。
 * - light：白底，节点像"发光药丸"贴在白画布上，靠深霓虹描边勾勒。
 */
