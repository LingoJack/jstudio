...
// ────────────────────────────────────────────────
// Tool Call Bubble - 工具调用审批气泡
// ────────────────────────────────────────────────

/** Tool icon + color mapping */
const TOOL_META: Record<string, { icon: typeof Terminal; color: string }> = {
...
function parseToolArgs(name: string, rawArgs: string): ParsedToolArgs {
