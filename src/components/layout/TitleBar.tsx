...
export default function TitleBar() {
  ...
  return (
    <div
      ...
      className="h-9 shrink-0 flex items-center justify-between bg-[var(--vscode-activityBar-background)] border-b border-[var(--vscode-menu-border)] px-3 select-none relative z-toolbar"
    >
